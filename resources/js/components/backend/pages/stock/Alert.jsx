...
const List = () => {
  ...
  useEffect(() => {
      document.title = 'Alert Stock List'
      axios.get('/api/stock-alert').then(res => {setStock(res.data.data), setList(res.data.data)});
      setLoading(false);
  }, [])
      ...
      <div className="col-xl-12 col-md-12 col-sm-12">
        <div className="card">
          <div className="card-header">
            <h5 className='d-inline'>Alert Stock List </h5>
