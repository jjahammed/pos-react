...
const New = () => {
    ...
    const [inputValue, setInputValue] = useState({
      ...
      const submitForm = (e) => {
        ...
        axios.post('/api/investment',formData).then(res => {
                        ...
                        <div className="col-sm-12">
                            <form className="theme-form" onSubmit={submitForm}>
                                <div className="card">
                                    ...
                                    <Input type='text' name='amount' lblText='investment amount' value={inputValue.amount} error={inputValue.error_log.amount} onChange={handleInput2} placeholder='investment amount' className='form-control' />

                                    <Date lblText='Investment Date' value={date} setDateFunction={setDateFunction} error={inputValue.error_log.purcheased_date}  className='form-control'/>
