                            ...
                            <form className="theme-form" onSubmit={submitForm}>
                                <div className="card">
                                    ...
                                    <div className="card-body">
                                            ...
                                            <Select name='category_id' value={inputValue.category_id} opValue='' opText='Select A Category' lblText='Select A Category' error={inputValue.error_log.category_id} onChange={handleInput} className='form-control'>
                                              {category.map( (item) => {
