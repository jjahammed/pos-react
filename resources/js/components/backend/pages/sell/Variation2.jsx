...
const Variation = ({rowsData, deleteTableRows, handleChange}) => {
    return(
        ...
        rowsData.map((data, index)=>{
            const {product_id,product_pid,product_title,product_price,product_image,product_qty,total_price,modelNumber}= data;
            return(
                ...
                <tr className='text-center' key={product_id}>
                    ...
                    <input type="text" value={modelNumber} onChange={(evnt)=>(handleChange(index, evnt))} name="modelNumber" className="form-control text-center"/>
                    </td>

                    <td scope="col" width={'10%'}> 
                    <input type="number" value={product_price} onChange={(evnt)=>(handleChange(index, evnt))} name="product_price" className="form-control text-center"/>
                    </td>
                    <td scope="col" width={'10%'}> 
