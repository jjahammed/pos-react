...
const Userinfo = ({inputValue,inputHandle}) => {
  return (
    <div className="row">
    <div className="col-xl-12 col-12">
        ...
        <Input type='email' name='email' lblText='email' value={inputValue.email} error={inputValue.error_log.email} onChange={inputHandle} placeholder='email' className='form-control' />
