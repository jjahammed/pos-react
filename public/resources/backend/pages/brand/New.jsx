                            ...
                            <form className="theme-form" onSubmit={submitForm}>
                                <div className="card">
                                    ...
                                    <div className="card-body">
                                            ...
                                            <Input type='text' name='name' lblText='Brand Name' value={inputValue.name} error={inputValue.error_log.name} onChange={handleInput} placeholder='Brand Name' className='form-control' />
