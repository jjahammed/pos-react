    ...
    const handleInput = (e) => {
      ...
      useEffect(() => {
        document.title = 'Brand Edit'
          axios.get(`/api/brand/${slug}/edit`).then((res) => {
      ...
      const submitForm = (e) => {
        ...
        axios.post(`/api/brand/${slug}`,formData).then(res => {
          if(res.data.status === 200){
                            ...
                            <form className="theme-form" onSubmit={submitForm}>
                                <div className="card">
                                    ...
                                    <div className="card-body">
                                            ...
                                            <Input type='text' name='name' lblText='Brand Name' value={inputValue.name} error={inputValue.error_log.name} onChange={handleInput} placeholder='Category Name' className='form-control' />
                                    ...
                                    <div className="card-footer">
                                        ...
                                        <Link to='/admin/brand' className="d-inline p-2 btn btn-secondary">Cancel</Link>
                                    </div>
                                </div>
                            </form>
                            <ToastContainer />
