...
const List = () => {
  ...
  useEffect(() => {
      ...
      axios.get('/api/purcheased-product/create').then(res => {setStock(res.data.data), setList(res.data.data)});
      setLoading(false);
        ...
        <div className="card">
          <div className="card-header">
            ...
            <span className='d-inline badge btn-primary text-light'>{stock.length}</span>
              <Link to='/admin/purcheased-product/return/new' className='btn btn-primary pull-right'><i className="fa-regular fa-plus text-bold text-light"></i></Link>
          </div>
