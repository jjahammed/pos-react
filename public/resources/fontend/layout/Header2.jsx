    ...
    <div className="row">
      <div className="col-12 col-md-4 col-sm-12">
        <div className="grocerino-logo text-left"> 
          <Link to="/"> 
            <img src="/resources/fontend/assets/img/logos/logo.png" alt="Grocery Product Image" className="img-fluid" /> 
          </Link>
        </div>
      </div>
        ...
        <div className="top-right text-right">
          <ul className="list-inline">
            ...
            <li className="account-view">
              <Link to="customer-account.html"><img src="/resources/fontend/assets/img/logos/profile-img.png" alt="Profile" title="Profile" /></Link>
            </li>
          </ul>
        </div>
      </div>
          ...
          <nav className="navbar navbar-expand-lg navbar-dark px-0">
            ...
            <div className="collapse navbar-collapse bg-dark" id="navbarCollapse">
              <ul className="navbar-nav mr-auto">
                ...
                <li className="nav-item">
                  <Link className="nav-link" to="customer-account.html"> My Profile</Link>
                </li>
                <li className="nav-item">
                  <Link className="nav-link" to="contact-us.html">Contact Us</Link>
                </li>
              </ul>
            </div>
          </nav>
